...
%Arbeitsgruppe von Prof. Dr. Thiel-Clemen
%Entwicklung von skalierbaren Multi-Agenten Simulationen
...
%Analyse
%Präsentation 
%von Geo-Daten beschäftigen

\subsection{Rasterdaten Typen}
3 Arten

\subsubsection{Thematische (diskrete) Daten (Discrete data)}
Repräsentieren die Landnutzung oder Bodendaten.
...
\begin{figure}[H]
  \centering
  	%\includegraphics[width=\columnwidth]{img/gis_raster}
  	\includegraphics[height=114pt]{img/gis_raster}
  	%\includegraphics[height=1/6\textheight]{img/gis_raster}
...
\subsubsection{Kontinuierliche Daten (Continuous data)}
Stellen Ereignisse wie Temperatur und Höhenmeter sowie spektrale Daten wie Satellitenbilder und Luftaufnahmen dar.

\subsubsection{Bilder (Picture data)}
Die gescannte Karten oder Zeichnungen zeigen, sowie Gebäudeaufnahmen


\subsection{GIS Rastertypen}
%- Raster als Grundkarten
%- Raster als Oberflächenkarten
%- Raster als thematische Karte
%- Raster als Beschreibung eines Objekts
