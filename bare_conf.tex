...
\section{Rasterdaten Typen}
%1. Thematische (diskrete) Daten (Discrete data) repräsentieren die Landnutzung
%oder Bodendaten.
%2. Kontinuierliche Daten (Continuous data) stellen Ereignisse wie Temperatur und
%Höhenmeter sowie spektrale Daten wie Satellitenbilder und Luftaufnahmen dar.
%3. Bilder (Picture data), die gescannte Karten oder Zeichnungen zeigen, sowie
%Gebäudeaufnahmen


\section{GIS Rastertypen}
...
\section{client Server Modell erklären}
%
